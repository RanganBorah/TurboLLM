        ...
        <div className="mt-12 max-w-4xl mx-auto rounded-xl bg-slate-900 p-5 sm:p-7 comic-panel">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 items-center text-center">
            ...
            <div className={`p-3.5 rounded-lg border transition-colors ${
              ...
              <div className="text-[10px] text-slate-500 mt-1.5">Context Token</div>
            </div>
            ...
            <div className={`p-3.5 rounded-lg border transition-colors ${
              ...
              <div className="text-[10px] text-slate-400 font-mono mt-1">~3ms / token</div>
            </div>

            {/* Step 3: Candidate Tokens */}
            <div className={`p-3 rounded-lg border transition-colors md:col-span-1 ${
              animStep >= 1 ? 'bg-slate-950 border-slate-700' : 'bg-slate-950/50 border-slate-800 opacity-60'
            }`}>
            ...
            <div className={`p-3.5 rounded-lg border transition-colors ${
              ...
              <div className="text-[10px] text-slate-400 font-mono mt-1">Parallel Verification</div>
            </div>

            {/* Step 5: Speedup Outcome */}
            <div className={`p-3.5 rounded-lg border transition-colors ${
              animStep >= 4 ? 'bg-slate-950 border-emerald-500/40' : 'bg-slate-950/50 border-slate-800 opacity-60'
            }`}>
              ...
              <div className="text-[10px] text-slate-400 mt-1">4 accepted + 1 corrected</div>
            </div>
